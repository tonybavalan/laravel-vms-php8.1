...
$('.page-content .message').on('click', function () {
  swal({
...
$('.page-content .success').on('click', function () {
  swal({
      title: 'Saved succesfully..!!',
      type: 'success',
      padding: '2em'
        ...
        $("#flexCheckDefault1").val('');
        $("#flexCheckDefault2").val('');
        $("#inlineRadio1").val('');
    })
...
$('.page-content .success1').on('click', function () {
  swal({
